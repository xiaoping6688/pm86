    ...
    function refreshMetadata() {
      ...
      HttpRequest.post({
        ...
        if (km_data.disabled == true) {
          console.error(chalk.cyan('[PM86.io]') + ' Server DISABLED BY ADMINISTRATION contact support contact@keymetrics.io with reference to your public and secret keys)');
          return Daemon.exit();
        }
...
if (require.main === module) {
  console.log(chalk.cyan.bold('[PM86.io]') + ' Launching agent');
  process.title = 'PM2: PM86.io Agent';
